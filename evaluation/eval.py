...
def evaluate(inputs, preds, refs, types=None, name='test', save_path=None, per_sent_file_name=None, confidence=0.95, use_old_checkpoints=False):
    args = Box({
        'batch_size': 16,
